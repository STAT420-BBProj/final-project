...
>>>>>>> parent of 6c647b4... added Leave One Out Cross Validation metrics for all of the models
---
...
plot_predicted_wins_versus_actual_wins <- function(model_name, predicted_wins, actual_wins, avg_pct_error, rmse){
  ...
  sub <- paste("Average Percent Error: ", round(avg_pct_error,2), " %", "   RMSE: ", round(rmse,2))
